...
if (rootElement) {
  if (window !== window.parent) {
    ...
    mount(
      ...
      if (!isCompareInitial && !customDoc) {
        // Seed default demo form fields showcasing multi-user assignment, custom typography & colors, and flow order
        instance.formManager.setFields([
          {
            id: 'sample_f1',
          ...
          },
          {
            ...
            type: 'dropdown',
            options: ['Software Engineer', 'Product Manager', 'Legal Counsel', 'Director'],
            pageIndex: 1,
            x: 320,
            y: 180,
            width: 220,
          ...
          },
          {
            id: 'sample_f3',
            name: 'reviewer_notes',
            label: 'Compliance Reviewer Notes',
          ...
          },
          {
            ...
            type: 'checklist',
            options: ['Identity verified', 'Background check completed', 'Approved for sign-off'],
            pageIndex: 1,
            x: 60,
            y: 330,
            width: 320,
          ...
          {
            id: 'sample_f7',
            name: 'executive_digital_sign',
            label: 'Executive Approval',
            type: 'digital_signature',
            signatureType: 'digital',
            signTagText: 'DIGITAL SIGN',
            pageIndex: 1,
            x: 300,
            y: 440,
            width: 240,
